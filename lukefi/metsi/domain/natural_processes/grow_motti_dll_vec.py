...
def _spedom(stand: ForestStand) -> int:
    """
...
class MottiDLLPredictorVec:
    ...
    def evolve(self, step: int = 5) -> GrowthDeltas:
        ...
        spedom = _spedom_from_soa(self.stand)
...
def grow_motti_dll_vec(input_: Tuple["ForestStand", None], /, **operation_parameters) -> Tuple["ForestStand", None]:
    """
