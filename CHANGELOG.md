...
- Renamed key classes and concepts for simulator control
- Refactored and moved domain specific elements to more suitable packages

## [3.2.5] - 2025-10-01

### Added

- Support for vectorized Motti growth model 
- Unit test for vectorized wrapper

## [3.2.4] - 2025-09-24

### Added

- Support for grow_metsi_vec growth model
- Unit test for vectorized wrapper
...
- Implemented Treatment postcondition handling

### Changed

- Treatment conditions renamed to preconditions

## [3.1.0] - 2025-09-22

### Added

- Implemented Treatment condition handling

## [3.0.2] - 2025-09-19

### Changed

- Refactored EventTree generation to use the declared Generator and Treatment objects instead of NestableGenerator

## [3.0.1] - 2025-09-18

### Fixed

- Fixed crash when running without MetsiGrow
