...
source("./tests/forestry/resources/cross_cutting/ApteerausNasberg.R")
source("./tests/forestry/resources/cross_cutting/Runkokayraennusteet.R")
source("./tests/forestry/resources/cross_cutting/Tilavuus.R")
source("./tests/forestry/resources/cross_cutting/Runkokayran korjausmalli.R")
source("./tests/forestry/resources/cross_cutting/Korjauskertoimet.R")


taper_curve_list <- list("birch" = readRDS(file.path("./tests/forestry/resources/cross_cutting/taper_curves/birch.rds")),
                         "pine" = readRDS(file.path("./tests/forestry/resources/cross_cutting/taper_curves/pine.rds")),
                         "spruce" = readRDS(file.path("./tests/forestry/resources/cross_cutting/taper_curves/spruce.rds")))

timber_grades_table <- read.table("./tests/forestry/resources/cross_cutting/Puutavaralajimaarittelyt.txt")
