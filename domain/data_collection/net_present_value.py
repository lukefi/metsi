...
from domain.collected_types import CrossCutResult, NPVResult, PriceableOperationInfo
from domain.utils.file_io import get_renewal_costs_as_dict, get_land_values_as_dict
