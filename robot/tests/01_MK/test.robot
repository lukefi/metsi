...
${INPUT_JSON}     robot/tests/01_MK/in/demo.json
${OUTPUT_DIR}     robot/tests/01_MK/out/test
${CONTROL_SCRIPT}  robot/tests/01_MK/in/demo_control_sim2.py
${REFERENCE_DIR}  robot/tests/01_MK/out/ref
